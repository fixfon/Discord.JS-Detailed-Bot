...
module.exports = async (oldMember, newMember) => {
    ...
    if (!newMember.client.config.get(newMember.guild.id).get('logEvents') && !newMember.client.config.get(newMember.guild.id).get('logEvents').get('guildLog').enabled &&
        !newMember.client.config.get(newMember.guild.id).get('logEvents').get('guildLog').channelID) return

    const logCh = newMember.guild.channels.cache.find(ch => ch.id == newMember.client.config.get(newMember.guild.id).get('logEvents').get('guildLog').channelID)
